...
$sql="INSERT INTO `payment`(`company_id`, `user_id`, `payment_amount`, `payment_status`, `tranc_id`, `ref_id`)VALUES ('3','4','453','INCOMPLETE','$txnid','$hashKey')";
    ...
    <?php } ?>
      ...
      <input type="hidden" name="txnid" value="<?php echo $txnid ?>" />
          <div class="form-group">
              ...
              <input name="firstname" class="form-control" id="firstname" value="name" />
            
          </div>
          <div class="form-group">
              <label for="email">Email<span style="color:red" >*</span></label>
              <input class="form-control" name="email" id="email" value="name@dfgdfgd.sff" />
          </div>
          <div class="form-group">
              <label for="phone">Phone<span style="color:red" >*</span></label>
              <input id="phone" class="form-control" name="phone" value="9999999999"/>
          </div>
